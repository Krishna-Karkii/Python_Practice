# 12th Day
# we learned to give argument/multiple_arguments to a function today
# we also learned a bit of a concept of decoupling
# we learned about a new method of string called split where it splits and stores-
# -strings into list which is rather useful getting multiple input from the user
